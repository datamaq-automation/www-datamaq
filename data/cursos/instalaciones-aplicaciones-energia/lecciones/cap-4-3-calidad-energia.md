...
- **Bancos Automáticos**: Utilizan un controlador inteligente que mide la corriente y tensión de la planta para conectar o desconectar pasos de capacitores mediante contactores específicos (equipados con resistencias de preinserción para limitar corrientes de inrush).
